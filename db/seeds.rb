...
beach_life_subscription = Product.create(title: "Beach Life", subtitle: "Beach Life Subscription", author: "Jodie Parker", price: "4.99", sku: "BLP2", 
		description: %{<p>Beach Life is a photograph collection of life on the beach around West Cornwall.</p>

            <p>In this subscription, You will have access to the whole of the Beach Life library that best portray life on the beach through the seasons.</p>
            <p><strong>What You'll Get</strong></p>
            <ul class="no-indent">
                <li>Beach Life Subscription</li>
    ...
    details: %{  
            <ul id="details-infobox" class="list-group">
              <li class="list-group-item active clearfix">DETAILS</li>
              <li class="list-group-item">6 Months Unlimited Access</li>
              <li class="list-group-item clearfix">
                <span class="pull-left content-qualifier">Terms of Use</span>
                <span class="pull-right">Personal Use / 1 Commercial Use</span>
              </li>
